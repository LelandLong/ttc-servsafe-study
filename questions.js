...
var questionsDB = [
  ...
  },
  {
    ...
    correct: 0,
    hint: "Think about what makes bacteria grow — and how to stop it.",
    explanation: "Controlling time and temperature is the most important way to prevent bacterial foodborne illness. Bacteria multiply rapidly in the Temperature Danger Zone (41°F-135°F), so keeping food at safe temperatures and cooking to proper internal temperatures is the primary defense.",
    category: "Foodborne Illness",
    chapter: 2,
    examFocus: true
  },
  {
    ...
    correct: 0,
    hint: "Viruses can't be killed by cooking — so what's the best defense?",
    explanation: "Practicing good personal hygiene is the most important method for preventing viral foodborne illness. Unlike bacteria, viruses cannot be destroyed by normal cooking temperatures and do not grow in food. They spread through infected food handlers, so handwashing, excluding sick employees, and avoiding bare-hand contact with ready-to-eat food are the critical controls.",
    category: "Foodborne Illness",
    chapter: 2,
    examFocus: true
  },
