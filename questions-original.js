...
// This is the ORIGINAL template containing all 93 questions as of initial release.
...
originalQuestionsDB.forEach(function(q) {
  if (originalCategories.indexOf(q.category) === -1) {
    originalCategories.push(q.category);
  }
});
